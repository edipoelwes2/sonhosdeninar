    ...
    <div class="dash">
        <aside class="dash_sidebar">
            <article class="dash_sidebar_user">
                <img class="dash_sidebar_user_thumb" src="{{ url(asset('assets/images/avatar.jpg')) }}" alt=""
                    title="" />
            ...
            <ul class="dash_sidebar_nav">
                ...
                <li class="dash_sidebar_nav_item {{ isActive('admin.users') }}"><a class="icon-users"
                    ...
                    <ul class="dash_sidebar_nav_submenu">
                        <li class="{{ isActive('admin.users') }}"><a href="{{ route('admin.users.index') }}">Ver
                                Todos</a></li>
                ...
                <li class="dash_sidebar_nav_item"><a class="icon-home"
                        href="dashboard.php?app=properties/index">Imóveis</a>
                    <ul class="dash_sidebar_nav_submenu">
